...
namespace QuantityMeasurementBusinessLayer
{
    public class QuantityMeasurementServiceImpl : IQuantityMeasurementService
    {
        ...
        private static void ValidateSameCategory(QuantityDTO a, QuantityDTO b)
        {
            ...
            {
                throw new QuantityMeasurementException($"Cannot operate on different categories: '{a.Category}' and '{b.Category}'.");
            }
        }
        ...
        private static void ValidateArithmeticSupported(QuantityDTO dto, string operation)
        {
            ...
            {
                throw new QuantityMeasurementException($"Temperature does not support {operation} operations.");
            }
        }
