...
namespace QuantityMeasurementApp.Tests
{
    ...
    public class ExtendLengthEqualityTest
    {
        ...
        public void yardEquals36Inches()
        {
            ...
            var inches = new Length(36, LengthUnit.Inches);
        ...
        {
            var cm = new Length(100, LengthUnit.Centimeters);
            var inches = new Length(39.3701, LengthUnit.Inches);
        ...
        {
            var cm = new Length(30.48, LengthUnit.Centimeters);
        ...
        {
            var yard = new Length(1, LengthUnit.Yards);
            var inch = new Length(20, LengthUnit.Inches);
