...
namespace QuantityMeasurementApp.Tests
{
    ...
    public class LengthEqualityTests
    {
        ...
        public void Setup()
        {
            feetOne = new Length(1.0, Length.LengthUnit.Feet);
            feetTwo = new Length(1.0, Length.LengthUnit.Feet);
            inchOne = new Length(1.0, Length.LengthUnit.Inches);
            inchTwo = new Length(1.0, Length.LengthUnit.Inches);
        }
        ...
        {
            var inches = new Length(12.0, Length.LengthUnit.Inches);
        ...
        {
            var feetDifferent = new Length(2.0, Length.LengthUnit.Feet);
        ...
        {
            var inchDifferent = new Length(2.0, Length.LengthUnit.Inches);
        ...
        {
            var inches = new Length(10.0, Length.LengthUnit.Inches);
        ...
        {
            var feet3 = new Length(1.0, Length.LengthUnit.Feet);
            Assert.That(feetOne.Equals(feetTwo), Is.True);
