...
namespace QuantityMeasurementRepository.Cache
{
    ...
    public class QuantityMeasurementJsonCacheRepository : IQuantityMeasurementRepository
    {
        ...
        //WriteIndented = true -formatting of code in human readable format
        ...
        public string GetPoolStatistics() => $"[JsonCacheRepository] File: {_filePath} | Entries in cache: {_cache.Count}";
