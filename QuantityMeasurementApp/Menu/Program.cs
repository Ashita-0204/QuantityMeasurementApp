            ...
            do
            {
                ...
                switch (choice)
                {
                    ...
                    case 12:
                        ...
                        Console.WriteLine("1 -> Equality");
                        Console.WriteLine("2 -> Conversion");
                        Console.WriteLine("3 -> Unsupported Arithmetic Demo");
                        ...
                        if (tempChoice == 1)
                        {
                            ...
                            Console.WriteLine($"Equal: {t1.Equals(t2)}");
                        }
                        ...
                        else if (tempChoice == 2)
                        {
                            ...
                            var temp = new Quantity<TemperatureUnit>(val, from);

                            double resut = temp.ConvertTo(to);

                            Console.WriteLine($"Converted: {resut} {to}");
                        }
